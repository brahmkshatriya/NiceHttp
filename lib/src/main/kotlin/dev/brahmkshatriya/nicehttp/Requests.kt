...
val defaultParser = object : ResponseParser{
...
open class Requests(
    ...
    var responseParser: ResponseParser? = defaultParser,
) {
    companion object {
    ...
    // Regretful copy and paste function args, but I am unsure how to do it otherwise
    /**
